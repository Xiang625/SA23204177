...
__tt__ is a simple R package developed to test whether the sample mean vector is a zero vector (Wang and Shao, 2020) using R, Rcpp and RcppEigen (implemented through the R package _Rcpp_ and _RcppEigen_).
